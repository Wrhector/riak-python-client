...
class RiakPbcCodec(object):
    ...
    def _decode_content(self, rpb_content, sibling):
        ...
        :type rpb_content: riak.riak_pb.RpbContent
    ...
    def _decode_link(self, link):
        ...
        :type link: riak.riak_pb.RpbLink
        :rtype tuple
        """
    ...
    def _encode_bucket_props(self, props, msg):
        ...
        :type msg: riak.riak_pb.RpbSetBucketReq
        """
    ...
    def _decode_bucket_props(self, msg):
        ...
        :type msg: riak.riak_pb.RpbBucketProps
        :rtype dict
        """
        props = {}
    ...
    def _decode_modfun(self, modfun):
        ...
        :type modfun: riak.riak_pb.RpbModFun
        :rtype dict
        """
    ...
    def _encode_modfun(self, props, msg=None):
        ...
        :type props: dict
        :param msg: the protobuf message to fill
        :type msg: riak.riak_pb.RpbModFun
        :rtype riak.riak_pb.RpbModFun
        """
        if msg is None:
            msg = riak.riak_pb.RpbModFun()
    ...
    def _decode_hook(self, hook):
        ...
        :type hook: riak.riak_pb.RpbCommitHook
        :rtype dict
        """
    ...
    def _encode_hook(self, hook, msg):
        ...
        :type hook: dict
        :param msg: the protobuf message to fill
        :type msg: riak.riak_pb.RpbCommitHook
        :rtype riak.riak_pb.RpbCommitHook
        """
        if 'name' in hook:
    ...
    def _encode_index_req(self, bucket, index, startkey, endkey=None,
        ...
        :rtype riak.riak_pb.RpbIndexReq
        """
        req = riak.riak_pb.RpbIndexReq(bucket=str_to_bytes(bucket.name),
                                  index=str_to_bytes(index))
        self._add_bucket_type(req, bucket.bucket_type)
        if endkey is not None:
            req.qtype = riak.riak_pb.RpbIndexReq.range
            req.range_min = str_to_bytes(str(startkey))
            req.range_max = str_to_bytes(str(endkey))
        else:
            req.qtype = riak.riak_pb.RpbIndexReq.eq
    ...
    def _decode_search_index(self, index):
        ...
        :type index: riak.riak_pb.RpbYokozunaIndex
        :rtype dict
        """
        result = {}
    ...
    def _encode_map_update(self, dtype, msg, op):
        if dtype == 'counter':
            ...
            if op == 'enable':
                msg.flag_op = riak.riak_pb.MapUpdate.ENABLE
            else:
                msg.flag_op = riak.riak_pb.MapUpdate.DISABLE
    ...
    def _decode_preflist(self, item):
        ...
        :type preflist: list of riak.riak_pb.RpbBucketKeyPreflistItem
        :rtype dict
        """
